...
class Dev extends command_ts_1.BuiltInModule {
    constructor(cts) {
        super();
        this.cts = cts;
    }
    reload(i) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.cts.registry.reloadAll();
            yield this.cts.registry.syncCommands();
            yield i.editReply({
